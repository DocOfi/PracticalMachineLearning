...
```{r, Accplot, fig.width=6, fig.height=4}
plot(rfor_fitall)
```
...
```{r, CompModelall, results='asis', warning=FALSE, message=FALSE}
print(kable(Model_accuracy$byClass))
```

**Model with 20 variables**

```{r, CompModel20, results='asis', warning=FALSE, message=FALSE}
...
```{r, CompSecT, results='asis', warning=FALSE, message=FALSE}
print(kable(Model_accuracyall_2$byClass))
```

**Model with 4 predictors**

```{r, CompSecT2, results='asis', warning=FALSE, message=FALSE}
...
```{r, correctplotall, fig.width=6, fig.height=4}
...
```{r, correctplot20, fig.width=6, fig.height=4}
...
```{r, correctplot8, fig.width=6, fig.height=4}
...
```{r, correctplot4, fig.width=6, fig.height=4}
